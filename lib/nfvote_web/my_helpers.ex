defmodule KandiresWeb.MyHelpers do
  def format_price([]) do
    format_price(nil)
  end
  ...
  def get_pdf_template_url(order_nr, mode, _params \\ %{})
      when is_binary(order_nr) and is_binary(mode) do
    Elixir.Application.get_env(:kandis, :local_url) <>
      KandiresWeb.Router.Helpers.page_path(KandiresWeb.Endpoint, :html_for_pdf, mode, order_nr)
  end
end
